                    ...
                    <TD>
                      <Link href={`/app/clients/${c.id}`} className="flex items-center gap-2.5">
                        ...
                        <span className="min-w-0">
                          ...
                          <span className="ltr-nums block font-mono text-meta text-ink-subtle">{c.clientNumber}</span>
                        </span>
                      </Link>
                    </TD>
                    <TD className="hidden text-ink-muted md:table-cell"><span className="ltr-nums block">{c.email ?? "—"}</span><span className="ltr-nums block text-meta text-ink-subtle">{c.phone}</span></TD>
